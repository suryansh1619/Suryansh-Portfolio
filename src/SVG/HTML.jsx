export default function HTML({color}){
	return (
        <svg fill={color} version="1.1" viewBox="0 0 512 512" enableBackground="new 0 0 512 512" ><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
